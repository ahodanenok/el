...
class GreaterEqualValueExpression extends ValueExpressionBase {

    final ValueExpression left;
    final ValueExpression right;

    GreaterEqualValueExpression(ValueExpression left, ValueExpression right) {
        this.left = left;
        this.right = right;
    }
    ...
    public boolean equals(Object obj) {
        if (obj == null || obj.getClass() != GreaterEqualValueExpression.class) {
            return false;
        }

        GreaterEqualValueExpression other = (GreaterEqualValueExpression) obj;
