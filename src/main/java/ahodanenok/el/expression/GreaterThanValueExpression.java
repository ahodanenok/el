...
class GreaterThanValueExpression extends ValueExpressionBase {

    final ValueExpression left;
    final ValueExpression right;

    GreaterThanValueExpression(ValueExpression left, ValueExpression right) {
        this.left = left;
        this.right = right;
    }
    ...
    public boolean equals(Object obj) {
        if (obj == null || obj.getClass() != GreaterThanValueExpression.class) {
            return false;
        }

        GreaterThanValueExpression other = (GreaterThanValueExpression) obj;
