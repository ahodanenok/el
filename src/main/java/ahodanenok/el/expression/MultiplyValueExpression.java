...
class MultiplyValueExpression extends ValueExpressionBase {
    ...
    public <T> T getValue(ELContext context) {
        try {
            ...
            throw new ELException("Failed to multiply", e);
        }
    }
    ...
    private <T> T getValueInternal(ELContext context) {
        ...
        if (leftValue == null && rightValue == null) {
            ...
            return (T) context.convertToType(leftValue, BigDecimal.class)
                .multiply(context.convertToType(rightValue, BigDecimal.class));
            ...
            return (T) context.convertToType(leftValue, BigInteger.class)
                .multiply(context.convertToType(rightValue, BigInteger.class));
        } else {
    ...
    public boolean equals(Object obj) {
        if (obj == null || obj.getClass() != MultiplyValueExpression.class) {
            return false;
        }

        MultiplyValueExpression other = (MultiplyValueExpression) obj;
