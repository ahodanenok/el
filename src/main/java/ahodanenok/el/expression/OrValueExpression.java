...
class OrValueExpression extends ValueExpressionBase {

    final ValueExpression left;
    final ValueExpression right;

    OrValueExpression(ValueExpression left, ValueExpression right) {
        this.left = left;
        this.right = right;
    }
    ...
    public boolean equals(Object obj) {
        if (obj == null || obj.getClass() != OrValueExpression.class) {
            return false;
        }

        OrValueExpression other = (OrValueExpression) obj;
