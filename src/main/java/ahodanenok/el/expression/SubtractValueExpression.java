...
class SubtractValueExpression extends ValueExpressionBase {
    ...
    SubtractValueExpression(ValueExpression left, ValueExpression right) {
    ...
    public <T> T getValue(ELContext context) {
        try {
            ...
            throw new ELException("Failed to subtract", e);
        }
    }
    ...
    private <T> T getValueInternal(ELContext context) {
        ...
        if (leftValue == null && rightValue == null) {
            ...
            return (T) context.convertToType(leftValue, BigInteger.class)
                .subtract(context.convertToType(rightValue, BigInteger.class));
        } else {
    ...
    public boolean equals(Object obj) {
        if (obj == null || obj.getClass() != SubtractValueExpression.class) {
            return false;
        }

        SubtractValueExpression other = (SubtractValueExpression) obj;
