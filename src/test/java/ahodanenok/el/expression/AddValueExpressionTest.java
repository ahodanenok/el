...
public class AddValueExpressionTest {
    ...
    public void testAdd_BigDecimal_X() {
        ...
        assertEquals(BigDecimal.valueOf(3.5), expr.getValue(context));
    }

    @Test
    public void testAdd_X_BigDecimal() {
    ...
    @Test
    public void testAdd_Float_BigInteger() {
        ...
        var expr = new AddValueExpression(
            new StaticValueExpression(leftValue), new StaticValueExpression(rightValue));
        assertEquals(BigDecimal.valueOf(10.5), expr.getValue(context));
    }

    @Test
    public void testAdd_BigInteger_Float() {
    ...
    public void testAdd_Float_X() {
        ...
        var expr = new AddValueExpression(
            new StaticValueExpression(leftValue), new StaticValueExpression(rightValue));
        assertEquals(Double.valueOf(6.5), expr.getValue(context));
    }

    @Test
    public void testAdd_X_Float() {
    ...
    @Test
    public void testAdd_Double_BigInteger() {
    ...
    @Test
    public void testAdd_BigInteger_Double() {
        Object leftValue = BigInteger.TEN;
    ...
    @Test
    public void testAdd_String_BigInteger() {
        ...
        var expr = new AddValueExpression(
            new StaticValueExpression(leftValue), new StaticValueExpression(rightValue));
        assertEquals(BigDecimal.valueOf(12.7), expr.getValue(context));
    }

    @Test
    public void testAdd_BigInteger_String() {
        Object leftValue = BigInteger.TEN;
    ...
    public void testAdd_String_X() {
        ...
        var expr = new AddValueExpression(
            new StaticValueExpression(leftValue), new StaticValueExpression(rightValue));
        assertEquals(Double.valueOf(4.7), expr.getValue(context));
    }

    @Test
    public void testAdd_X_String() {
    ...
    @Test
    public void testAdd_BigInteger_X() {
        Object leftValue = BigInteger.TEN;
        Object rightValue = "3";
        ExpressionFactory ef = ExpressionFactoryStubs.coerceToValue(
        ...
        var expr = new AddValueExpression(
            new StaticValueExpression(leftValue), new StaticValueExpression(rightValue));
        assertEquals(BigInteger.valueOf(13), expr.getValue(context));
    }

    @Test
    public void testAdd_X_BigInteger() {
        Object leftValue = "3";
        Object rightValue = BigInteger.TEN;
        ExpressionFactory ef = ExpressionFactoryStubs.coerceToValue(
    ...
    public void testAdd_Other() {
        ...
        var expr = new AddValueExpression(
            new StaticValueExpression(leftValue), new StaticValueExpression(rightValue));
        assertEquals(Long.valueOf(7), expr.getValue(context));
    }
