...
public class GreaterEqualValueExpressionTest {
    ...
    public List<DynamicTest> testCompare() {
        return List.of(
            ...
            dynamicTest("bigdecimal_x_gt_true", () -> check(true, BigDecimal.valueOf(1.2), 1.1, BigDecimal.valueOf(1.2), BigDecimal.valueOf(1.1), BigDecimal.class)),
            ...
            dynamicTest("x_bigdecimal_gt_true", () -> check(true, 20, BigDecimal.valueOf(19), BigDecimal.valueOf(20), BigDecimal.valueOf(19), BigDecimal.class)),
            dynamicTest("x_bigdecimal_eq_true", () -> check(true, 20, BigDecimal.valueOf(20), BigDecimal.valueOf(20), BigDecimal.valueOf(20), BigDecimal.class)),
            ...
            dynamicTest("float_x_gt_true", () -> check(true, 2.5f, 2, 2.5, 2.0, Double.class)),
            ...
            dynamicTest("x_float_gt_true", () -> check(true, 2, 1.5f, 2.0, 1.5, Double.class)),
            ...
            dynamicTest("double_x_gt_true", () -> check(true, 2.5, 2, 2.5, 2.0, Double.class)),
            dynamicTest("double_x_eq_true", () -> check(true, 2.0, 2, 2.0, 2.0, Double.class)),
            dynamicTest("double_x_false", () -> check(false, 2.5, 3, 2.5, 3.0, Double.class)),
            dynamicTest("x_double_gt_true", () -> check(true, 2, 1.5, 2.0, 1.5, Double.class)),
            dynamicTest("x_double_eq_true", () -> check(true, 1.5f, 1.5, 1.5, 1.5, Double.class)),
            dynamicTest("x_double_false", () -> check(false, 2, 2.5, 2.0, 2.5, Double.class)),
            dynamicTest("biginteger_x_gt_true", () -> check(true, BigInteger.valueOf(2), 1, BigInteger.valueOf(2), BigInteger.valueOf(1), BigInteger.class)),
            dynamicTest("biginteger_x_eq_true", () -> check(true, BigInteger.valueOf(1), 1, BigInteger.valueOf(1), BigInteger.valueOf(1), BigInteger.class)),
            ...
            dynamicTest("byte_x_gt_true", () -> check(true, (byte) 3, 2, 3L, 2L, Long.class)),
            ...
            dynamicTest("x_byte_gt_true", () -> check(true, 3, (byte) 2, 3L, 2L, Long.class)),
            dynamicTest("x_byte_eq_true", () -> check(true, 3, (byte) 3, 3L, 3L, Long.class)),
            dynamicTest("x_byte_false", () -> check(false, 2, (byte) 3, 2L, 3L, Long.class)),
            dynamicTest("short_x_gt_true", () -> check(true, (short) 3, 2, 3L, 2L, Long.class)),
            dynamicTest("short_x_eq_true", () -> check(true, (short) 3, 3, 3L, 3L, Long.class)),
            dynamicTest("short_x_false", () -> check(false, (short) 2, 3, 2L, 3L, Long.class)),
            dynamicTest("x_short_gt_true", () -> check(true, 3, (short) 2, 3L, 2L, Long.class)),
            dynamicTest("x_short_eq_true", () -> check(true, 1, (short) 1, 1L, 1L, Long.class)),
            dynamicTest("x_short_false", () -> check(false, 2, (short) 3, 2L, 3L, Long.class)),
            dynamicTest("integer_x_gt_true", () -> check(true, 3, "2", 3L, 2L, Long.class)),
            ...
            dynamicTest("x_integer_gt_true", () -> check(true, "3", 2, 3L, 2L, Long.class)),
            dynamicTest("x_integer_eq_true", () -> check(true, "2", 2, 2L, 2L, Long.class)),
            dynamicTest("x_integer_false", () -> check(false, "2", 3, 2L, 3L, Long.class)),
            dynamicTest("long_x_gt_true", () -> check(true, 3L, "2", 3L, 2L, Long.class)),
            dynamicTest("long_x_eq_true", () -> check(true, 4L, "4", 4L, 4L, Long.class)),
            dynamicTest("long_x_false", () -> check(false, 2L, "3", 2L, 3L, Long.class)),
            dynamicTest("x_long_gt_true", () -> check(true, "3", 2L, 3L, 2L, Long.class)),
            dynamicTest("x_long_eq_true", () -> check(true, "2", 2L, 2L, 2L, Long.class)),
            dynamicTest("x_long_false", () -> check(false, "2", 3L, 2L, 3L, Long.class)),
            dynamicTest("char_x_gt_true", () -> check(true, 'a', 59, 60L, 59L, Long.class)),
            ...
            dynamicTest("x_char_gt_true", () -> check(true, 61, 'a', 61L, 60L, Long.class)),
            dynamicTest("x_char_eq_true", () -> check(true, 61, 'b', 61L, 61L, Long.class)),
            dynamicTest("x_char_false", () -> check(false, 59, 'a', 59L, 60L, Long.class)),
            dynamicTest("x_biginteger_gt_true", () -> check(true, "2", BigInteger.valueOf(1), BigInteger.valueOf(2), BigInteger.valueOf(1), BigInteger.class)),
            ...
            dynamicTest("string_x_gt_true", () -> check(true, "b", new Object(), "b", "a", String.class)),
            dynamicTest("string_x_eq_true", () -> check(true, "b", new Object(), "b", "b", String.class)),
            dynamicTest("string_x_false", () -> check(false, "a", new Object(), "a", "b", String.class)),
            dynamicTest("x_string_gt_true", () -> check(true, new Object(), "a", "b", "a", String.class)),
            dynamicTest("x_string_eq_true", () -> check(true, new Object(), "a", "b", "b", String.class)),
            dynamicTest("x_string_false", () -> check(false, new Object(), "b", "a", "b", String.class)),
            dynamicTest("comparable_gt_true", () -> check(true, LocalDate.of(2025, 1, 2), LocalDate.of(2025, 1, 1), null, null, null)),
    ...
    public void testCompare_Error() {
        ...
        var expr = new GreaterEqualValueExpression(
