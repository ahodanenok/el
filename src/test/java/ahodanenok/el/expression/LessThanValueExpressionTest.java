...
public class LessThanValueExpressionTest {
    ...
    public List<DynamicTest> testCompare() {
        return List.of(
            ...
            dynamicTest("bigdecimal_x_true", () -> check(true, BigDecimal.valueOf(1.2), 2, BigDecimal.valueOf(1.2), BigDecimal.valueOf(2), BigDecimal.class)),
            ...
            dynamicTest("x_bigdecimal_true", () -> check(true, 10, BigDecimal.valueOf(11), BigDecimal.valueOf(10), BigDecimal.valueOf(11), BigDecimal.class)),
            ...
            dynamicTest("float_x_true", () -> check(true, 2.5f, 3, 2.5, 3.0, Double.class)),
            dynamicTest("float_x_false", () -> check(false, 2.5f, 2, 2.5, 2.0, Double.class)),
            dynamicTest("x_float_true", () -> check(true, 2, 2.5f, 2.0, 2.5, Double.class)),
            dynamicTest("x_float_false", () -> check(false, 2, 1.5f, 2.0, 1.5, Double.class)),
            dynamicTest("double_x_true", () -> check(true, 2.5, 3, 2.5, 3.0, Double.class)),
            dynamicTest("double_x_false", () -> check(false, 2.5, 2, 2.5, 2.0, Double.class)),
            dynamicTest("x_double_true", () -> check(true, 2, 2.5, 2.0, 2.5, Double.class)),
            dynamicTest("x_double_false", () -> check(false, 2, 1.5, 2.0, 1.5, Double.class)),
            dynamicTest("biginteger_x_true", () -> check(true, BigInteger.valueOf(2), 3, BigInteger.valueOf(2), BigInteger.valueOf(3), BigInteger.class)),
            ...
            dynamicTest("byte_x_true", () -> check(true, (byte) 2, 3, 2L, 3L, Long.class)),
            dynamicTest("byte_x_false", () -> check(false, (byte) 3, 2, 3L, 2L, Long.class)),
            dynamicTest("x_byte_true", () -> check(true, 2, (byte) 3, 2L, 3L, Long.class)),
            dynamicTest("x_byte_false", () -> check(false, 3, (byte) 2, 3L, 2L, Long.class)),
            dynamicTest("short_x_true", () -> check(true, (short) 2, 3, 2L, 3L, Long.class)),
            dynamicTest("short_x_false", () -> check(false, (short) 3, 2, 3L, 2L, Long.class)),
            dynamicTest("x_short_true", () -> check(true, 2, (short) 3, 2L, 3L, Long.class)),
            dynamicTest("x_short_false", () -> check(false, 3, (short) 2, 3L, 2L, Long.class)),
            dynamicTest("integer_x_true", () -> check(true, 2, "3", 2L, 3L, Long.class)),
            dynamicTest("integer_x_false", () -> check(false, 3, "2", 3L, 2L, Long.class)),
            dynamicTest("x_integer_true", () -> check(true, "2", 3, 2L, 3L, Long.class)),
            dynamicTest("x_integer_false", () -> check(false, "3", 2, 3L, 2L, Long.class)),
            dynamicTest("long_x_true", () -> check(true, 2L, "3", 2L, 3L, Long.class)),
            dynamicTest("long_x_false", () -> check(false, 3L, "2", 3L, 2L, Long.class)),
            dynamicTest("x_long_true", () -> check(true, "2", 3L, 2L, 3L, Long.class)),
            dynamicTest("x_long_false", () -> check(false, "3", 2L, 3L, 2L, Long.class)),
            dynamicTest("char_x_true", () -> check(true, 'a', 61, 60L, 61L, Long.class)),
            dynamicTest("char_x_false", () -> check(false, 'a', 59, 60L, 59L, Long.class)),
            dynamicTest("x_char_true", () -> check(true, 59, 'a', 59L, 60L, Long.class)),
            dynamicTest("x_char_false", () -> check(false, 61, 'a', 61L, 60L, Long.class)),
            dynamicTest("x_biginteger_true", () -> check(true, "1", BigInteger.valueOf(2), BigInteger.valueOf(1), BigInteger.valueOf(2), BigInteger.class)),
            ...
            dynamicTest("x_string_true", () -> check(true, new Object(), "b", "a", "b", String.class)),
            dynamicTest("x_string_false", () -> check(false, new Object(), "a", "b", "a", String.class)),
            dynamicTest("comparable_true", () -> check(true, LocalDate.of(2025, 1, 1), LocalDate.of(2025, 1, 2), null, null, null)),
    ...
    public void testCompare_Error() {
        ...
        var expr = new LessThanValueExpression(
