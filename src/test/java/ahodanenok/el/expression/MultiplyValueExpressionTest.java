...
public class MultiplyValueExpressionTest {

    @Test
    public void testMultiply_Nulls() {
    ...
    public void testMultiply_BigDecimal_X() {
        ...
        assertEquals(BigDecimal.valueOf(3.0), expr.getValue(context));
    }

    @Test
    public void testMultiply_X_BigDecimal() {
    ...
    @Test
    public void testMultiply_Float_BigInteger() {
        ...
        var expr = new MultiplyValueExpression(
            new StaticValueExpression(leftValue), new StaticValueExpression(rightValue));
        assertEquals(BigDecimal.valueOf(5.0), expr.getValue(context));
    }

    @Test
    public void testMultiply_BigInteger_Float() {
    ...
    @Test
    public void testMultiply_Float_X() {
        ...
        var expr = new MultiplyValueExpression(
            new StaticValueExpression(leftValue), new StaticValueExpression(rightValue));
        assertEquals(Double.valueOf(10.0), expr.getValue(context));
    }

    @Test
    public void testMultiply_X_Float() {
    ...
    @Test
    public void testMultiply_Double_BigInteger() {
    ...
    @Test
    public void testMultiply_BigInteger_Double() {
        Object leftValue = BigInteger.TEN;
    ...
    @Test
    public void testMultiply_Double_X() {
    ...
    @Test
    public void testMultiply_X_Double() {
        Object leftValue = Integer.valueOf(4);
    ...
    @Test
    public void testMultiply_String_BigInteger() {
        ...
        var expr = new MultiplyValueExpression(
            new StaticValueExpression(leftValue), new StaticValueExpression(rightValue));
        assertEquals(BigDecimal.valueOf(27.0), expr.getValue(context));
    }

    @Test
    public void testMultiply_BigInteger_String() {
        Object leftValue = BigInteger.TEN;
    ...
    @Test
    public void testMultiply_String_X() {
        Object leftValue = "2.7";
        Object rightValue = true;
        ExpressionFactory ef = ExpressionFactoryStubs.coerceToValue(
            new ExpressionFactoryStubs.ConversionRule(leftValue, Double.valueOf(2.7), Double.class),
            new ExpressionFactoryStubs.ConversionRule(rightValue, Double.valueOf(2), Double.class));
        StandardELContext context = new StandardELContext(ef);
        context.putContext(ExpressionFactory.class, ef);
        var expr = new MultiplyValueExpression(
            new StaticValueExpression(leftValue), new StaticValueExpression(rightValue));
        assertEquals(Double.valueOf(5.4), expr.getValue(context));
    }

    @Test
    public void testMultiply_X_String() {
        Object leftValue = true;
        Object rightValue = "2.7";
        ExpressionFactory ef = ExpressionFactoryStubs.coerceToValue(
            new ExpressionFactoryStubs.ConversionRule(leftValue, Double.valueOf(2), Double.class),
            new ExpressionFactoryStubs.ConversionRule(rightValue, Double.valueOf(2.7), Double.class));
        StandardELContext context = new StandardELContext(ef);
        context.putContext(ExpressionFactory.class, ef);
        var expr = new MultiplyValueExpression(
            new StaticValueExpression(leftValue), new StaticValueExpression(rightValue));
    ...
    @Test
    public void testMultiply_BigInteger_X() {
        Object leftValue = BigInteger.TEN;
        Object rightValue = "3";
        ExpressionFactory ef = ExpressionFactoryStubs.coerceToValue(
        ...
        var expr = new MultiplyValueExpression(
            new StaticValueExpression(leftValue), new StaticValueExpression(rightValue));
        assertEquals(BigInteger.valueOf(30), expr.getValue(context));
    }

    @Test
    public void testMultiply_X_BigInteger() {
        Object leftValue = "3";
        Object rightValue = BigInteger.TEN;
        ExpressionFactory ef = ExpressionFactoryStubs.coerceToValue(
    ...
    @Test
    public void testMultiply_Other() {
        Object leftValue = Integer.valueOf(2);
    ...
    @Test
    public void testMultiply_NoConversion() {
